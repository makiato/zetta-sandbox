...
public class PGPKeyUtil {
	...
	private static PGPKeyUtil INSTANCE = null;
	private static KeyFingerPrintCalculator KFPC = new BcKeyFingerprintCalculator();

	public static PGPKeyUtil getInstance() {

		if (INSTANCE == null)
			INSTANCE = new PGPKeyUtil();
		return INSTANCE;
	}
	...
	public PGPPublicKey readPublicKey(InputStream in) throws IOException, PGPException {
		...
		PGPPublicKeyRingCollection pgpPub = new PGPPublicKeyRingCollection(in, KFPC);
	...
	public PGPPrivateKey findSecretKey(InputStream keyIn, long keyID, char[] pass)
		...
		PGPSecretKeyRingCollection pgpSec = new PGPSecretKeyRingCollection(
				org.bouncycastle.openpgp.PGPUtil.getDecoderStream(keyIn), KFPC);
